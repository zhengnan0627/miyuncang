<template>
	<view class="container">
		<u-navbar  :title="`${title}通道盘点任务列表`" :title-width="400" :background="{background: 'transparent'}" back-icon-color="#ffffff" title-color="#ffffff" :border-bottom="false"></u-navbar>
				...
				<view class="list-content2" >
					...
					<view class="content-text2">
						...
						<template v-if="current == 1">
							<view class="text-item2 text-last"  @click="goodsdetail(item,index)">
								<text class="item-textclass">账面数量:&nbsp</text> 
